...
const email = (<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
                    ...
                    <div className="flex space-x-4">
                      {navigation.map((item) =>
                        item.externalLink ? (
                          ...
                          >
                            {item.icon ? (
                              <div className="w-6 h-6 nav-icons">
                                {item.icon}
                              </div>) : item.name}
                          </a>
                        ) : (
